...
A2 [IO]: Load {{context_file}} → verify:
  ...
  - `.solutioning` exists (option_analysis, solution_design, traceability)
...
B8 [IO]: Read `.solutioning.level_of_effort` — overall_complexity, component_count, risk_surface, uncertainty_flags
...
```json
{
  ...
  "solutioning_summary": { "recommended_option": "", "components_count": 0 },
  "quality_bar": { "all_ac_covered": false, "test_coverage": "", "gaps_count": 0, "unknowns_count": 0 },
  "state_tracking": { "total_phases": 4, "completed_phases": 4, "wsjf_score": 0.0 }
}
```
...
Tell user: **"Workflow complete. Work item ready for development. Use /ticket-grooming-phase-06-dev-closeout after development."**
