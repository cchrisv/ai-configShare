...
**CRITICAL:** Use the rich HTML template for this field. See `#file:.github/templates/field-bug-description.html` for the complete styled template.
...
**CRITICAL:** Use the rich HTML template for this field. See `#file:.github/templates/field-bug-repro-steps.html` for the complete styled template.
...
**CRITICAL:** Use the rich HTML template for this field. See `#file:.github/templates/field-bug-system-info.html` for the complete styled template.
...
**CRITICAL:** Use the rich HTML template for this field. See `#file:.github/templates/field-bug-acceptance-criteria.html` for the complete styled template.
...
- **Root Cause Detail** (optional): `/fields/Custom.RootCauseDetail` → Process/context factors
