...
**Use the rich HTML template:** See `#file:.github/templates/field-feature-description.html` for the complete styled template with gradient headers, card layouts, and visual hierarchy.
...
**Use the rich HTML template:** See `#file:.github/templates/field-feature-business-value.html` for the complete styled template with color-coded value items and visual hierarchy.
...
**Use the rich HTML template:** See `#file:.github/templates/field-feature-objectives.html` for the complete styled template with gradient objective cards.
...
**Use the rich HTML template:** See `#file:.github/templates/field-feature-acceptance-criteria.html` for the complete styled template with color-coded success indicator cards.
