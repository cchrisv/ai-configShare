...
**CRITICAL:** Use the rich HTML template for this field. See `#file:.github/templates/field-user-story-description.html` for the complete styled template.
...
**CRITICAL:** Use the rich HTML template for this field. See `#file:.github/templates/field-user-story-acceptance-criteria.html` for the complete styled template.
