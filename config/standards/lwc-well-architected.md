...
**Format:** `{appPrefix}{AtomicLevel}{ComponentName}` — all components MUST use an app prefix.

| Context | Style | Example |
|---------|-------|---------|
| Folder/File | camelCase | `emplidLoaderOrganismStudentSearch` |
| HTML | kebab-case | `<c-emplid-loader-organism-student-search>` |
| Class | PascalCase | `EmplidLoaderOrganismStudentSearch` |
...
**Rules:** camelCase multi-word · 8-15 chars · `core` for cross-app · register new prefixes before use.
...
→ Apex: [apex-well-architected.md] · Logging: [nebula-logger-standards.md] · Feature flags: [feature-flags-standards.md]
