...
Runtime artifacts are stored in `.ai-artifacts/<work_item_id>/` (research, grooming, solutioning, wiki, finalization; dev-updates when using phase-08a/08b, closeout when using phase-09).
