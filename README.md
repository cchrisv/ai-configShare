...
Runtime artifacts are stored in `.ai-artifacts/<work_item_id>/` (research, grooming, solutioning, wiki, finalization; dev-updates and closeout when using phase-08/09).
...
- `util-reformat-ticket.prompt.md` - Re-apply HTML templates to an ADO work item (formatting only, no content changes)
...
| Phase | Prompt | Re-run |
|-------|--------|--------|
| Research | `phase-03-research.prompt.md` | `re-phase.prompt.md` |
| Grooming | `phase-04-grooming.prompt.md` | `re-phase.prompt.md` |
| Solutioning | `phase-05-solutioning.prompt.md` | `re-phase.prompt.md` |
| Wiki | `phase-06-wiki.prompt.md` | `re-phase.prompt.md` |
| Finalization | `phase-07-finalization.prompt.md` | `re-phase.prompt.md` |
| Dev Update | `phase-08-dev-update.prompt.md` | Iterative dev-time updates to grooming/solutioning/ADO |
| Dev Closeout | `phase-09-dev-closeout.prompt.md` | Full closeout: planned vs actual, ADO + wiki |

Use `re-phase.prompt.md` to re-run any individual phase with existing artifacts.
